...
class ProductController extends Controller
{
    ...
    /**
     * @Route("admin/product/add/image", name="addProductImage", methods="GET|POST")
     */
    public function addProductImage(Request $request)
    {
        $productImage = new ProductImage();
        $entityManager = $this->getDoctrine()->getManager();
        $imageForm = $this->createForm(ProductImageType::class, $productImage);
        ...
        if ($imageForm->isSubmitted() && $imageForm->isValid()) {
            ...
            $file = $imageForm->get('filepath')->getData();
        ...
        return $this->render('product/partial/add_image.html.twig', [
